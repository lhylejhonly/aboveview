...
export function StoreHeader({ onOpenLogin, onOpenProfile }: { onOpenLogin?: () => void; onOpenProfile?: () => void }) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[#DDD9D2] bg-[#FCFBF9] text-[#242220] shadow-[0_2px_12px_rgba(31,29,27,0.06)]">
      <div className="relative mx-auto flex h-[68px] w-full max-w-[1920px] items-center justify-between overflow-hidden px-3 sm:h-20 sm:px-10 lg:px-16">
        ...
        <nav className="ml-auto flex min-w-0 items-center justify-end gap-1.5 sm:h-full sm:w-1/2 sm:gap-5 lg:gap-8" aria-label="Store actions">
